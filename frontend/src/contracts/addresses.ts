export const contracts = {
  sepolia: {
    ...
    solarProject: (process.env.NEXT_PUBLIC_SOLAR_PROJECT ||
    ...
    revenueDistributor: (process.env.NEXT_PUBLIC_REVENUE_DISTRIBUTOR ||
      '0x0000000000000000000000000000000000000004') as `0x${string}`,
    hostReputation: (process.env.NEXT_PUBLIC_HOST_REPUTATION ||
