...
contract LoanManagerTest is BaseTest {
    ...
    function setUp() public override {
        ...
        // Mint SBT for host so slashScore works on default
        vm.prank(host);
    ...
    function test_NextPaymentDueUpdatedAfterPayment() public {
        ...
        // Capture the first deadline (T + 30 days)
        (,,,,, uint256 initialDue,,,,,) = loanManager.projectLoans(projectId);
        ...
        // Assert that the new due date is the initial deadline + 30 days (T + 60 days)
        assertEq(nextPaymentDue, initialDue + 30 days);
    }
