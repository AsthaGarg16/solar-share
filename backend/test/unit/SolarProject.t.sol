...
contract SolarProjectTest is BaseTest {
    ...
    function test_ProjectIdIncrements() public {
        vm.startPrank(host);
        uint256 id1 = solarProject.initializeProject(TARGET_AMOUNT, TERM_MONTHS, TOTAL_SHARES, "ENPHASE_123");
        uint256 id2 = solarProject.initializeProject(TARGET_AMOUNT, TERM_MONTHS, TOTAL_SHARES, "ENPHASE_123");
        vm.stopPrank();
        assertEq(id1, 1);
        assertEq(id2, 2);
    }
