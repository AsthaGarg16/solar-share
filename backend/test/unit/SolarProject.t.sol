...
contract SolarProjectTest is BaseTest {
    ...
    function test_InitializeProject() public {
        vm.prank(host);
        projectId = solarProject.initializeProject("Test Project", TARGET_AMOUNT, TERM_MONTHS, TOTAL_SHARES);
    ...
    function test_ProjectIdIncrements() public {
        vm.startPrank(host);
        uint256 id1 = solarProject.initializeProject("Project 1", TARGET_AMOUNT, TERM_MONTHS, TOTAL_SHARES);
        uint256 id2 = solarProject.initializeProject("Project 2", TARGET_AMOUNT, TERM_MONTHS, TOTAL_SHARES);
        vm.stopPrank();
        assertEq(id1, 1);
        assertEq(id2, 2);
    }
