...
contract FullSystemTest is BaseTest {
    ...
    function test_GovernanceProposal_Passed() public {
        ...
        vm.prank(investor1);
        uint256 proposalId =
            dao.submitProposal(projectId, "Replace damaged inverter", proposalAmount, payable(vendorAddr));
    ...
    function test_GovernanceProposal_Rejected() public {
        ...
        uint256 proposalAmount = 500 * 10 ** 6;
        vm.prank(investor1);
        uint256 proposalId = dao.submitProposal(projectId, "Replace inverter", proposalAmount, payable(vendorAddr));
